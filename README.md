...
|------|------|
| 📚 **查看文档** | 点击主页课程表或侧边栏导航 |
| 🤖 **提问AI助手** | 点击右下角AI按钮，输入问题（试试 `/code` `/plan` `/teacher` `/think` `/quality`） |
| 🔗 **快速导航** | 粘贴官方文档URL，自动跳转对应页面 |
| 💾 **保存对话** | 对话自动跨页面同步 |
| 🧭 **消息动作栏** | 每条 AI 回复下方可复制、分享、重试和评价 |
...
/think      → 思维过程评价（判断是否复制粘贴、是否主动追问）
/quality    → 代码质量评价（给代码评分并提出改进建议）
...
✅ 代码分析、计划制定、教学讲解、思维过程评价、代码质量评价5种模式  
✅ 学习进度自适应  
✅ 对话历史跨页面同步  
✅ 代码语法高亮  
✅ 响应式设计（桌面/平板/手机）  
